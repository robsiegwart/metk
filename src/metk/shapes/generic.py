...
class HollowRectangle(DoublySymmetricShape):
    ...
    def Ix(self):
        return (
            1
            / 12
            * (self.w * self.h**3 - (self.w - 2 * self.t) * (self.h - 2 * self.t) ** 3)
        )
    ...
    def Iy(self):
        return (
            1
            / 12
            * (self.h * self.w**3 - (self.h - 2 * self.t) * (self.w - 2 * self.t) ** 3)
        )

    @property
    def Zx(self):
        return (
            self.w * self.h**2 / 4 - (self.w - 2 * self.t) * (self.h / 2 - self.t) ** 2
        )

    @property
    def Zy(self):
        return (
            self.h * self.w**2 / 4 - (self.h - 2 * self.t) * (self.w / 2 - self.t) ** 2
        )
