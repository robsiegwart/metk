...
class StructuralObject(metkObject):
            ...
            if isinstance(material, BaseMaterial):
                ...
                if named_material_exists(material):
                    ...
                    raise FileNotFoundError(
                        f'Cannot find source for material "{material}"'
                    )
    ...
    def Txy_lr(self):
        ...
        return (
            self.loads.m_z
            * (self.shape.cy_low**2 + self.shape.cx_right**2) ** 0.5
            / self.shape.J
        )
    ...
    def Txy_ll(self):
        ...
        return (
            self.loads.m_z
            * (self.shape.cy_low**2 + self.shape.cx_left**2) ** 0.5
            / self.shape.J
        )
    ...
    def Txy_ur(self):
        ...
        return (
            self.loads.m_z
            * (self.shape.cy_high**2 + self.shape.cx_right**2) ** 0.5
            / self.shape.J
        )
    ...
    def Txy_ul(self):
        ...
        return (
            self.loads.m_z
            * (self.shape.cy_high**2 + self.shape.cx_left**2) ** 0.5
            / self.shape.J
        )
    ...
    def von_mises(self):
        ...
        """
        return max(
            [stress.von_mises for stress in [self.Sll, self.Slr, self.Sul, self.Sur]]
        )
    ...
    def max_tensile(self):
        return max(self.Sa, self.Sbx_high, self.Sbx_low, self.Sby_left, self.Sby_right)
    ...
    def max_bending(self):
        return max(
            [
                abs(s)
                for s in [self.Sbx_low, self.Sbx_high, self.Sby_left, self.Sby_right]
            ]
        )
